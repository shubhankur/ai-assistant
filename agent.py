            ...
            async with activity_llm.chat(
                ...
                if(self.stage == 2):
                    ...
                    if(suggestion_list_json is None):
                        ...
                        self._session.say(ONBOARDING_PROMPTS["stage4_turn0"])
                    self.stage4_turn += 1 
                    raise StopResponse()
                    ...
                    if(routine_preview.upper() == "SATISFIED"):
                        ...
                        new_prompt = ONBOARDING_PROMPTS["stage6"]
                        ...
                        if(self.stage5_turn == 0):
                            self._session.say(ONBOARDING_PROMPTS["stage5_turn0"])
                        elif(self.stage5_turn == 1):
                            self._session.say(ONBOARDING_PROMPTS["stage5_turn1"])
                        else:
                            self.session.say(ONBOARDING_PROMPTS["stage5_turn2"])
                    self.stage5_turn += 1
                    raise StopResponse()
                elif(self.stage == 6):
                    ...
                    if (weekly_routine_json is None):
                        ...
                        self._session.say(ONBOARDING_PROMPTS["stage6_turn0"])
