import WeeklyRoutinePreview from "@/components/WeeklyRoutine"
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-slate-800 mb-2">Weekly Routine Preview</h1>
          <p className="text-slate-600">Review your schedule and make adjustments as needed</p>
        </div>
        <WeeklyRoutinePreview data={sampleData} />
      </div>
    </div>
  )
}
